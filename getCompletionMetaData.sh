...
file_sizes=$(find data/ -mindepth 1 -maxdepth 1 -print0 | xargs -0 du -s -b | sort -n)
...
echo The smallest file was $smallest_filename at "$smallest_filesize" Bytes
echo The largest file was $largest_filename at "$largest_filesize" Bytes
